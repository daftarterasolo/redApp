...
export class createFormLokoRedApp extends createFormMasyRedApp {
	#perushLokoData = [];
	#dataForm = {};
	...
	#setCssFormJml() {
        ...
        document.querySelector("#uttp").style.borderColor = "#FFFFFF";
        ...
        document.querySelector("#sn").style.borderColor = "#FFFFFF";
        document.querySelector("#buatan").style.borderColor = "#FFFFFF";
	}
